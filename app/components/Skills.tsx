...
const Skills = () => {
  return (
    <section className="p-8 mt-8">
      ...
      <div className="relative p-[2px] bg-gradient-to-r from-[#5C4B8A] to-[#FFD700] rounded-lg">
      ...
      <Link
        href="/skills"
        className="flex justify-end mt-5 mr-5 text-primary font-semibold cursor-pointer text-start hover:underline gap-1 items-center text-xl"
      >
        Details
        <FaChevronRight />
      </Link>
